# Example 01: Accelerometer waveforms from RedVox report DataWindow
...
In load_accelerometer.py, change input_dir (line 19) to the directory where the downloaded file
`dw_1648830257000498_2.pkl.lz4` is located.

### Example Output

<p align="center">
<img src="img/fig_ex_01.png">
</p>
